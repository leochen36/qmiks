...
(function(Q) {
    ...
    function uuid() {
        ...
        // here instead.
        var n = getIntegerBits(rand(random), 0, 7) + getIntegerBits(rand(random), 8, 15) + getIntegerBits(rand(random), 0, 7) + getIntegerBits(rand(random), 8, 15) + getIntegerBits(rand(random), 0, 15);
